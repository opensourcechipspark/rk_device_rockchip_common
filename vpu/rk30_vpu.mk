...
sf_lib_312xspec_files := $(shell ls $(CUR_PATH)/lib312xspec | grep .so)
PRODUCT_COPY_FILES += \
	      $(foreach file, $(sf_lib_312xspec_files), $(CUR_PATH)/lib312xspec/$(file):system/lib/$(file))

PRODUCT_COPY_FILES += \
		  $(foreach file, $(sf_lib_312xspec_files), $(CUR_PATH)/lib312xspec/$(file):obj/lib/$(file))
endif
